window.fetch('http://api.openweathermap.org/data/2.5/weather?q=Commentry&lang=fr&units=metric&appid=1f8c14072d202a541d6d06d2415fb1f9')
        .then(res => res.json())
        .then(function(res){
          console.log(res);
        ...
        document.getElementById('icon').setAttribute('src', 'http://openweathermap.org/img/w/'+res.weather[0].icon+'.png');
